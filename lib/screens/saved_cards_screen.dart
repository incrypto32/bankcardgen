...
class _SavedCardsScreenState extends State<SavedCardsScreen> {
  List savedCards=["axis.png","canara.png","federal.png","hdfc.png","hsbc.png","indiapost.png","sbi.png","southindian.png","union.png","yes.png"];
...
//     }
 Future<void> _shareImage(int index) async {
    try {
      final ByteData bytes = await rootBundle.load("assets/images/banktamlets/${savedCards[index]}");
      await Share.file(
